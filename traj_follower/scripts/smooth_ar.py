...
class SmoothAR:
    ...
    def transform_world(self):
        ...
        points_world[:,0]-= 0.19   # Adding the x offset 
        points_world[:,1]+= 0.03
        points_world[:,2]-= 0.06   # Adding the z offset 
...
if __name__ == '__main__':
    ...
    try:
        while not rospy.is_shutdown():
            if(smooth_ar_tracker.flag1 == 0):   # If we are in AR tag data collection mode 
                while True:
            ...
            if(smooth_ar_tracker.flag2 == 0):
                arr_temp= np.array(smooth_ar_tracker.traj_points)
                np.save('/home/ashish/Desktop/phantom_vision_ws/src/phantom_vision_project/traj_follower/scripts/full_traj1.npy', arr_temp)
                smooth_ar_tracker.flag2 = 1
            rate.sleep()
